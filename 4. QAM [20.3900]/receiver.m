...
x_hat1 = low_pass_filter(x_hat1,t,f_cutoff + 0.1);

x_hat2 = low_pass_filter(x_hat2,t,f_cutoff);
x_hat2 = low_pass_filter(x_hat2,t,f_cutoff + 0.1);
...
legend1 = sprintf('Coherent demodulator and two LPF cutoff frequency of %1.1f and %1.1f', f_cutoff, f_cutoff +0.1);
